...
public class VolumeInfo implements Parcelable {
    ...
    static {
        ...
        sStateToDescrip.put(VolumeInfo.STATE_UNMOUNTED, 1);
        sStateToDescrip.put(VolumeInfo.STATE_CHECKING, 2);
        sStateToDescrip.put(VolumeInfo.STATE_MOUNTED, 3);
        sStateToDescrip.put(VolumeInfo.STATE_MOUNTED_READ_ONLY, 4);
        sStateToDescrip.put(VolumeInfo.STATE_FORMATTING, 5);
        sStateToDescrip.put(VolumeInfo.STATE_EJECTING, 6);
        sStateToDescrip.put(VolumeInfo.STATE_UNMOUNTABLE, 7);
        sStateToDescrip.put(VolumeInfo.STATE_REMOVED, 8);
        sStateToDescrip.put(VolumeInfo.STATE_BAD_REMOVAL, 9);
    }
    ...
    public StorageVolume buildStorageVolume(Context context, int userId, boolean reportUnmounted) {
        ...
        if (type == TYPE_EMULATED) {
            ...
            try {
                Method method = storage.getClass().getMethod("findPrivateForEmulated",VolumeInfo.class);
                privateVol = (VolumeInfo) method.invoke(storage,this);
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            if (privateVol != null) {
                ...
                try {
                    Method method = storage.getClass().getMethod("getBestVolumeDescription",VolumeInfo.class);
                    description = (String) method.invoke(storage,this);
                } catch (Exception e) {
                    e.printStackTrace();
                }
...
//            mtpReserveSize = storage.getStorageLowBytes(userPath);
            ...
            removable = !ID_EMULATED_INTERNAL.equals(id);
        ...
        return new StorageVolume(id, mtpStorageId, userPath, description, isPrimary(), removable,
                emulated, mtpReserveSize, allowMassStorage, maxFileSize, userId,
    ...
    public Intent buildBrowseIntent() {
        ...
        final Intent intent = new Intent("android.provider.action.BROWSE_DOCUMENT_ROOT");
