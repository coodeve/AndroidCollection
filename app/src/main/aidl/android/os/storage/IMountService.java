...
public interface IMountService extends IInterface {
    ...
    abstract class Stub extends Binder implements IMountService {
     ...
     * consistent with MountServiceResultCode
     */
    int createSecureContainer(String id, int sizeMb, String fstype, String key,
                              int ownerUid, boolean external) throws RemoteException;
     ...
     */
    void mountObb(String rawPath, String canonicalPath, String key,
                  IObbActionListener token, int nonce) throws RemoteException;
     ...
     * int consistent with MountServiceResultCode
     */
    int mountSecureContainer(String id, String key, int ownerUid, boolean readOnly)
            throws RemoteException;
    ...
    int ENCRYPTION_STATE_NONE = 1;
    /** The volume has been encrypted succesfully. */
    int ENCRYPTION_STATE_OK = 0;
    /** The volume is in a bad state.*/
    int ENCRYPTION_STATE_ERROR_UNKNOWN = -1;
    /** Encryption is incomplete */
    int ENCRYPTION_STATE_ERROR_INCOMPLETE = -2;
    /** Encryption is incomplete and irrecoverable */
    int ENCRYPTION_STATE_ERROR_INCONSISTENT = -3;
    /** Underlying data is corrupt */
    int ENCRYPTION_STATE_ERROR_CORRUPT = -4;
     ...
     */
    int changeEncryptionPassword(int type, String password)
        throws RemoteException;
     ...
     * Returns an int consistent with MountServiceResultCode
     */
    int fixPermissionsSecureContainer(String id, int gid, String filename)
            throws RemoteException;
