package com.picovr.androidcollection.widget.progress;
...
public class ProgressStatusView extends View {
    ...
    public ProgressStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        loadSuccessColor = array.getColor(R.styleable.CustomStatusView_load_success_color, ContextCompat.getColor(context, R.color.colorPrimary));
        loadFailureColor = array.getColor(R.styleable.CustomStatusView_load_failure_color, ContextCompat.getColor(context, R.color.colorAccent));
