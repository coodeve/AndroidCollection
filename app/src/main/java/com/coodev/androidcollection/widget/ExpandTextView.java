...
public class ExpandTextView extends View implements View.OnClickListener {
    ...
    public ExpandTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        textSize = ta.getDimensionPixelSize(R.styleable.ExpandTextView_textSizes, 14);
        textColor = ta.getColor(R.styleable.ExpandTextView_textColors, 14);
    ...
    private synchronized void measureHeightState(String text, int width) {
        ...
        layout = new StaticLayout(text, textPaint, width - getPaddingLeft() - getPaddingRight(), Layout.Alignment.ALIGN_NORMAL, 1.4f, 0f, true);
            ...
            if (index < targetLine - 1) {
                ...
                if (targetLine == maxLines && maxLines < lineTexts.size()) {
                    ...
                    if (showTipDrawalbe) {
                        ...
                        int top = getHeight() - drawableHeight - getPaddingBottom() - (lineText.getBottomOffset() - lineText.getBaseLine());
