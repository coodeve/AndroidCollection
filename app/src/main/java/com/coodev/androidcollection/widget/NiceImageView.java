...
import com.coodev.androidcollection.Utils.ui.DpPxUtils;
...
public class NiceImageView extends AppCompatImageView {
    ...
    private int cornerRadius = (int) getResources().getDimension(R.dimen.common_conners_10); // 统一设置圆角半径，优先级高于单独设置每个角的半径
    ...
    public void setBorderWidth(int borderWidth) {
        this.borderWidth = DpPxUtils.dp2px(context, borderWidth);
    ...
    public void setInnerBorderWidth(int innerBorderWidth) {
        this.innerBorderWidth = DpPxUtils.dp2px(context, innerBorderWidth);
        clearInnerBorderWidth();
        invalidate();
    }
    ...
    public void setCornerRadius(int cornerRadius) {
        this.cornerRadius = DpPxUtils.dp2px(context, cornerRadius);
        calculateRadiiAndRectF(false);
    }

    public void setCornerTopLeftRadius(int cornerTopLeftRadius) {
        this.cornerTopLeftRadius = DpPxUtils.dp2px(context, cornerTopLeftRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerTopRightRadius(int cornerTopRightRadius) {
        this.cornerTopRightRadius = DpPxUtils.dp2px(context, cornerTopRightRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerBottomLeftRadius(int cornerBottomLeftRadius) {
        this.cornerBottomLeftRadius = DpPxUtils.dp2px(context, cornerBottomLeftRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerBottomRightRadius(int cornerBottomRightRadius) {
        this.cornerBottomRightRadius = DpPxUtils.dp2px(context, cornerBottomRightRadius);
        calculateRadiiAndRectF(true);
    }
