package com.coodev.androidcollection.widget.tablayout;
...
public class TabLayout extends HorizontalScrollView {
    ...
    private class SlidingTabIndicator extends LinearLayout {
        ...
        public void draw(Canvas canvas) {
            ...
            int r_space = ConvertUtils.dp2px(58);
            int l_space = ConvertUtils.dp2px(54);
            if (this.indicatorLeft >= 0 && this.indicatorRight > this.indicatorLeft) {
                ...
                selectedIndicator.setBounds(this.indicatorLeft + l_space, indicatorTop, this.indicatorRight - r_space, indicatorBottom);
